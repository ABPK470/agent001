...
function ActivePublishBadge({
  ...
  const toneClass =
    badge.tone === "success"
      ? "border-status-callout-ok-border bg-status-callout-ok-soft text-text-muted"
      : badge.tone === "warning"
        ? "border-status-callout-warn-border bg-status-callout-warn-soft text-text-muted"
