          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex shrink-0 items-center gap-1.5">
              {catalogView === "environments" && (
                <>
                  ...
                  <button
                    ...
                    className={[ICON_BTN_PRIMARY, isEnvironmentFormDirty ? CONTROL_READY : ""].filter(Boolean).join(" ")}
              ...
              <button
                ...
                className={[ICON_BTN_PRIMARY, isFormDirty ? CONTROL_READY : ""].filter(Boolean).join(" ")}
