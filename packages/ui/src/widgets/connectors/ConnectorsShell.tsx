    ...
    <>
      <div className="connectors flex h-full min-h-0 flex-1 flex-col overflow-hidden">
        <ModalToastStack toasts={toasts} onDismiss={dismissToast} />
              ...
              <div className="flex h-9 items-center justify-between gap-3">
                ...
                >
                  ...
                  <button
                    ...
                    tabIndex={view === "connectors" ? undefined : -1}
                    className={[ICON_BTN_PRIMARY, isDirty ? CONTROL_READY : ""].filter(Boolean).join(" ")}
            ...
            <div className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[minmax(0,auto)_minmax(0,1fr)] gap-0 lg:grid-cols-[minmax(16rem,0.95fr)_minmax(0,1.35fr)] lg:grid-rows-1">
