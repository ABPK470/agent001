/**
 * Charts module — entry point. Provides the `renderChart` dispatcher and the
 * `CHART_KINDS` recognised by the inline-diagram parser.
 */
...
export function renderChart(kind: ChartKind, spec: unknown): React.ReactElement {
  switch (kind) {
    ...
    case "dashboard": return <Dashboard   data={spec as DashboardData} />
  }
}
