  ...
  return (
    ...
    >
        ...
        <div className="px-3 pb-3 flex flex-wrap gap-2">
          {options.map((option) => (
            <button
              key={option}
              disabled={submitted}
              className="px-3 py-1.5 rounded-lg border border-accent/30 bg-overlay-2 text-base text-text hover:bg-accent/10 hover:border-accent/60 transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-overlay-2 disabled:hover:border-accent/30"
      ...
      <div className="px-3 pb-3 flex gap-2">
        ...
        />
        <button
          className="shrink-0 flex items-center justify-center w-9 h-9 bg-accent hover:bg-accent-hover text-text rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-accent"
