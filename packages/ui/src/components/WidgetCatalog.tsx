...
const CATALOG: Array<{ type: WidgetType, label: string, desc: string, Icon: ComponentType<{ size?: number, className?: string }> }> = [
  ...
  { type: "scd2-strategies", label: "SCD2 Strategies", desc: "Manage and fork SCD2 strategy templates referenced by entity definitions", Icon: Database },
  { type: "freeze-windows",  label: "Freeze Windows",  desc: "Schedule, list, and retire tenant freeze windows that gate sync runs",   Icon: Calendar },
