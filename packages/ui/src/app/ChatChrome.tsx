...
/** Frosted square control — chat shell icon buttons (session menu, sign-out). */
...
export const CHAT_CHROME_PILL =
  "flex h-10 w-auto max-w-[16rem] shrink-0 items-center gap-1.5 rounded-lg bg-panel/72 px-3 text-[13px] leading-none text-text-muted backdrop-blur transition-colors hover:bg-overlay-hover hover:text-text"
