/**
 * Delegation validation patterns — regex constants, evidence helpers, and
 * spec requirement classifiers.
 *
 * Extracted from delegation-validation.ts to keep each module under 500 LOC.
 *
 * @module
 */
 ...
 * context, not in normal English descriptions.
 */
