...
function buildCompareCatalogsTool(host: AgentHost): Tool {
  return {
...
function buildSyncPreviewTool(host: AgentHost): Tool {
  return {
    name: "sync_preview",
    description:
...
function buildSyncExecuteTool(host: AgentHost): Tool {
  return {
    name: "sync_execute",
    description:
...
function buildListEnvironmentsTool(host: AgentHost): Tool {
  return {
