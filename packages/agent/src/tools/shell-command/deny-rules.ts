/**
 * Shell command deny rules. Extracted from shell.ts.
 *
 * @module
 */

export const CONTAINER_RULES: Array<{ pattern: RegExp; label: string }> = [
...
export const HOST_ONLY_RULES: Array<{ pattern: RegExp; label: string }> = [
