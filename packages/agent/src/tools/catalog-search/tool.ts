  ...
  return {
    ...
    parameters: {
      ...
      properties: {
        search: {
          type: "string",
          description: "Keyword search across all table names and column names."
        },
        schema: {
          type: "string",
          description: "Filter search results to a specific schema. Use with search= to scope results."
        },
        table: {
          type: "string",
          description: "Get full details for a specific table. Schema-qualified: '<schema>.<Table>'."
        },
        column: {
          type: "string",
          description: "Find all tables that have a column with this exact name."
        },
        joins: {
          type: "string",
          description:
            "Show ALL join edges for a table — FK relationships and implicit joins. Schema-qualified."
        },
        path: {
          type: "array",
          items: { type: "string" },
