...
import {
  checkWriteIntegrity,
  extractDefinedNames,
  hasStructuralIntegrityIssue
} from "../filesystem-integrity.js"
      ...
      return buildToolOutcome(
        `WRITE REJECTED for ${filePath} — the mutation was blocked and the existing file was preserved.`,
        {
          ...
          artifacts: [
            {
              path: filePath,
              preservedExisting: hadExistingFile,
              requiresReadBeforeMutation: hadExistingFile
            }
          ],
          retryable: true
        }
