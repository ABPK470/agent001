 ...
 */
export function setMssqlConfig(host: AgentHost, config: sql.config, name = "default", knowledge: string | null = null): void {
...
export async function getPool(host: AgentHost, name = "default"): Promise<{ pool: sql.ConnectionPool; entry: DatabaseEntry }> {
