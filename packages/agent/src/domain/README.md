...
**What:** Shared words (`enums/`), shapes (`models/`), and domain services (`services/`).  
...
| `models/` | Types, constants, run/step transitions, errors, memory adapters |
| `services/` | Policy evaluator, audit, learner, domain events |

This folder is **not** “vocabulary only” — services are intentional.
