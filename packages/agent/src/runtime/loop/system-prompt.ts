 ...
 *   - Source / vitest:  import.meta.url is .../packages/agent/src/runtime/loop/system-prompt.ts
...
function resolvePromptCandidates(name: string): string[] {
  ...
  // 2. Source tree relative to this module (depth-3 escape from src/runtime/loop/).
