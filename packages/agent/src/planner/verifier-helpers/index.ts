import { VerifierOutcome, isVerifierOutcome } from "@mia/agent"
/**
...
import type { VerifierDecision, VerifierStepAssessment } from "../types.js"
...
export function parseOutcome(value: unknown): VerifierOutcome {
  ...
  if (isVerifierOutcome(s)) return s
