...
const TASK_INTENT_RE =
  /\b(?:build|create|write|run|fix|implement|deploy|query|count|analyze|analyse|find|list|show|generate|delete|update|edit|modify|test|verify|sync|migrate|refactor|fetch|pull|retrieve|inspect|scan|explore|calculate|compute|split|how many|how much)\b/i
