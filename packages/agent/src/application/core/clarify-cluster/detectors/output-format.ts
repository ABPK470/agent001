...
const SUMMARISE_PATTERN =
  /\b(summari[sz]e|summary|overview|recap|brief(?:ing)?|explain|describe|tell\s+me\s+about|what'?s\s+going\s+on)\b/i

const FORMAT_HINT_PATTERN =
