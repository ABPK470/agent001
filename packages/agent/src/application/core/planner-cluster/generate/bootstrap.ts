        ...
        diagnostics: [
          {
            ...
            code: "empty_bootstrap_response",
            message: "Planner bootstrap returned empty response"
          }
        ]
      }
    }
        ...
        diagnostics: [
          {
            category: DiagnosticCategory.Parse,
            severity: DiagnosticSeverity.Error,
            code: "invalid_bootstrap_json",
            message: "Planner bootstrap response is not valid JSON"
          }
        ]
      }
    }
        ...
        diagnostics: [
          {
            category: DiagnosticCategory.Parse,
            severity: DiagnosticSeverity.Error,
            code: "invalid_bootstrap_shape",
            message: "Planner bootstrap must include summary, architecture, and at least one artifact"
          }
        ]
      }
    }
      ...
      diagnostics: [
        {
          category: DiagnosticCategory.Parse,
          severity: DiagnosticSeverity.Error,
          code: "bootstrap_llm_error",
          message: `Planner bootstrap failed: ${errMsg}`
        }
      ]
    }
  }
