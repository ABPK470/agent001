...
| 4 | Second dialect (**hosted default: mssql**) + multi-dialect migrator | **In progress** — single Kysely handle; registry v1–7; time helpers; boot still refuses |
...
| `migrations/registry.ts` | Multi-dialect peer DDL (mssql v1–7; memory deferred to m8) |
