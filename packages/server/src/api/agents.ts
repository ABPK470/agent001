...
export function registerAgentRoutes(
	...
	app.post<{ Body: { name: string; description?: string; systemPrompt: string } }>("/api/agents", async (req, reply) => {
	...
	app.put<{ Params: { id: string }; Body: { name?: string; description?: string; systemPrompt?: string } }>("/api/agents/:id", async (req, reply) => {
