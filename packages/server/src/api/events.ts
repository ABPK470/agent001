...
export function registerEventRoutes(app: FastifyInstance): void {
	app.get<{ Querystring: { limit?: string; before?: string; after?: string; types?: string } }>("/api/events", async (req) => {
	...
	app.post<{ Body: { url: string; secret?: string; eventFilters?: string[]; enabled?: boolean } }>("/api/webhooks/drains", async (req, reply) => {
	...
	app.put<{ Params: { id: string }; Body: { url?: string; secret?: string; eventFilters?: string[]; enabled?: boolean } }>("/api/webhooks/drains/:id", async (req, reply) => {
