...
import { parseSyncDriftIntentForHost, parseSyncOperationIntentForHost } from "@mia/sync"
...
export function createBuildContext(opts: BuildSystemMessagesOptions): BuildContext {
  return {
    ...
    syncDriftIntent: opts.host ? parseSyncDriftIntentForHost(opts.goal, opts.host) : null
  }
}
